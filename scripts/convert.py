...
def main():
	...
	parser.add_argument("--model_dir", required=True, help="Directory containing the model to convert")
	parser.add_argument("--output_filename", help="Directory to save the converted model to")
